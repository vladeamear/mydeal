...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 12 2020 г., 13:50
...
(15, 'новый', 'looser.s.usami@gmail.com'),
(16, 'привет', 'kostik@mail.com');
...
(90, 'кек', '2020-11-08 19:46:07', '', NULL, 0, 'привет', 'kostik@mail.com'),
(91, 'кек кекович', '2020-11-08 19:46:57', '', '2020-11-08', 0, 'привет', 'kostik@mail.com'),
(92, 'ЫЫыыы', '2020-11-10 19:24:49', '', '2020-11-10', 1, 'Работа', 'kostik@mail.com'),
(93, 'kek', '2020-11-10 19:46:29', '', '2020-11-10', 1, 'Учеба', 'kostik@mail.com'),
(94, 'привет', '2020-11-10 19:57:09', '', '2020-11-10', 1, 'кокос', 'looser.s.usami@gmail.com');
...
('werfghbnm', '2020-11-12 13:06:29', 'looser.s.usami@yandex.ru', '$2y$10$uHrHyMbD9GZ4VmUOD9UOJepRJaNPGh/.y2aEzgF/pFa2O1qkiXjkO'),
...
--
ALTER TABLE `projects`
  MODIFY `id_projects` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT для таблицы `tasks`
--
ALTER TABLE `tasks`
  MODIFY `id_tasks` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
COMMIT;
